...
*------------------------------------------------------------------------------- 
	...
	* Consumption in usd
	...
	foreach cons_var in food_cons nonfood_cons {
		...
		* apply labels to new variables
		lab var `cons_var'_usd "``cons_var'_lab' in USD"
	...
	* Winsorize variables with the outliers
...
*------------------------------------------------------------------------------- 	
	...
	lab var sick 				"Any mmeber was sich in the last 4 weeks"
	lab var days_sick 			"Avarage sick days"
